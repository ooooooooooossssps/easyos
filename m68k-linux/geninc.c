...
#define FuncOffset(x)       (int)__easyos_GETJUMPVEC(0,x)

int main (void)
{
    printf ("/* Macros */\n"
	"#define easyos_CSYMNAME(n)       n\n"
	"#define easyos_CDEFNAME(n)       n\n"
	"#define easyos_SLIB_ENTRY(n,s)   s ## _ ## n\n"
	    "\n");
    ...
    printf ("\n/* struct easyos_cpu_context */\n");
    printf ("#define regs          %d\n", offsetof (struct easyos_cpu_context, regs));
    printf ("#define fpregs        %d\n", offsetof (struct easyos_cpu_context, fpregs));
