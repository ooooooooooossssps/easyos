...
*/
    ...
    .globl  easyos_SLIB_ENTRY(SMult32,Utility)
    .globl  easyos_SLIB_ENTRY(UMult32,Utility)
    .globl  easyos_SLIB_ENTRY(UMult32_020,Utility)

    .type   easyos_SLIB_ENTRY(SMult32,Utility),@function
    .type   easyos_SLIB_ENTRY(UMult32,Utility),@function
    .type   easyos_SLIB_ENTRY(UMult32_020,Utility),@function

easyos_SLIB_ENTRY(UMult32_020,Utility):
    mulu.l  %d1,%d0
    rts

easyos_SLIB_ENTRY(SMult32,Utility):
easyos_SLIB_ENTRY(UMult32,Utility):
/*
