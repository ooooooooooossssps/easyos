...
******************************************************************************/
	...
	.text
	.balign 16
	.globl	easyos_SLIB_ENTRY(Dispatch,Exec)
	.type	easyos_SLIB_ENTRY(Dispatch,Exec),@function

easyos_SLIB_ENTRY(Dispatch,Exec):
...
.nolnch: 
	...
	tst.b	easyos_CSYMNAME(supervisor)
	jbne	.noen
	jbsr	easyos_CSYMNAME(os_enable)
