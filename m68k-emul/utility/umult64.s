...
*/
    ...
    .globl  easyos_SLIB_ENTRY(UMult64_020,Utility)

    .type   easyos_SLIB_ENTRY(UMult64,Utility),@function
    .type   easyos_SLIB_ENTRY(UMult64_020,Utility),@function


easyos_SLIB_ENTRY(UMult64_020,Utility):
    mulu.l  %d0,%d0:%d1
    rts
...
easyos_SLIB_ENTRY(UMult64,Utility):
    movem.l  %d2-%d5,-(%sp)
