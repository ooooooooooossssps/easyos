...
static easyos_UFP3(ULONG, Alerthook_init,
    easyos_UFPA(void *,               dummy1,  D0),
    easyos_UFPA(BPTR,                 dummy2,  A0),
    easyos_UFPA(struct ExecBase *,    SysBase, A6)
);
...
easyos_UFH2(void, putChProc,
    easyos_UFHA(UBYTE, chr, D0),
    easyos_UFHA(STRPTR *, buf, A3))
{
    easyos_LIBFUNC_INIT
...
static easyos_UFH3(ULONG, Alerthook_init,
    easyos_UFHA(void *,               dummy1,  D0),
    easyos_UFHA(BPTR,                 dummy2,  A0),
...
static const struct Errors easyosstrings[] =
{
    {0, "unknown easyos.library error" }
};
